...
//
// ⚠️ ESPEJO de `client/src/lib/salutation.ts`. Los dos existen a propósito: el
// servidor lo necesita para precargar el borrador (initial-draft.ts) y el
// cliente para mostrar el saludo mientras se tipea el nombre, que no puede
// esperar un viaje al servidor por cada tecla. Si se toca uno, tocar el otro:
// los tests de este archivo son la red que avisa si se despegan.
