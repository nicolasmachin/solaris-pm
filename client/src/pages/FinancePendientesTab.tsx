...
// Confirma el cobro/pago real de un previsto manual (incluye cuotas del plan
// de pagos). Pide fecha real y cuenta destino, y transiciona PREVISTO→PAGADO.
function PayManualPendingModal({
  movementId,
  onClose,
  onPaid,
}: {
